...
A pure JavaScript-based webapp attempted to decode programs[^1] (a.k.a. "patches") for the Korg® microKORG®[^2] synth. These patches are usually stored either in PRG files or, less commonly, in SYX files.
